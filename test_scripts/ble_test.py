...
##            print(ii.addr)
            if ii.addr == ble01: # or ii.addr == ble02 \
               ...
               #or ii.addr== u'd4:36:39:dc:11:47':
                ...
                maf_ma1_dist = 10 ** ((-45-maf_ma1) * 0.05)
            ...
            if ii.addr == ble03:
                ...
                if maf_ma3_dist < 2.0:
                    ...
                    message3 = "Far"
                b3_data = { "distance": maf_ma3_dist, "positionX": 0.0, "positionY": 0.0, "name": "laptop", "rssi": maf_ma2, "message": message3, "id": 3}
            ...
            if ii.addr == ble04:
                ...
                if maf_ma4_dist < 2.0:
                    ...
                    message4 = "Far"
                b4_data = { "distance": maf_ma4_dist, "positionX": 0.0, "positionY": 0.0, "name": "table", "rssi": maf_ma2, "message": message4, "id": 4}
